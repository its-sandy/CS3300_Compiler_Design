...
// int checkClique(int bitPattern)
// {
// 	bitset<32> clique(bitPattern);
// 	int i,j;

// 	cout<<"bitpattern:- "<<bitPattern<<" num_set_bits:- "<<clique.count()<<" ";
// 	cout<<clique;
...
// 			if(clique[i] && clique[j] && !colives[i][j])
// 			{
// 				cout<<" --- 0 -- "<<i<<" "<<j<<endl;
// 				return 0;
// 			}
// 	cout<<" --- "<<clique.count()<<endl;
// 	return clique.count();
// }
