...
%token-table
%start program
%token DATA_TYPE IF_TOK WHILE_TOK BREAK_TOK CONTINUE_TOK RETURN_TOK ASS_OP IDENTIFIER_TOK INT_LITERAL FLOAT_LITERAL PLUSMIN STAR
%nonassoc pexp
%nonassoc onlyif
%nonassoc ELSE_TOK
%left LOG_OR
...
decl_list 		:   decl decl_list	{makeTree;}
				|   decl 			{makeTree;}
				;
...
param_list 		: 	param ',' param_list 	{makeTree;}
				|	param 					{makeTree;}
				;
...
stmt_list 		: 	stmt stmt_list 		{makeTree;}
				| 	stmt 				{makeTree;}
				;
...
local_decls 	: 	local_decl local_decls   		{makeTree;}
				| 	epsilon 						{makeTree;}
				;
...
arg_list 		: 	expr ',' arg_list 	{makeTree;}
				| 	expr				{makeTree;}
				;
