...
{
  "$end", "error", "$undefined", "TERM", "NON_TERM", "':'", "';'", "'|'",
  "'$'", "$accept", "GRAMMAR", "RULES", "RULE", "PRODUCTIONS",
  "PRODUCTION", "ALPHA", YY_NULLPTR
};
#endif
...
{
       0,   256,   257,   258,   259,    58,    59,   124,    36
};
# endif
...
{
       0,     4,    10,    11,    12,     5,     0,    12,     3,     4,
       8,    13,    14,    15,     6,     7,     3,     4,    14
};
...
yyreduce:
  ...
  switch (yyn)
    {
        case 5:
#line 36 "l5.y" /* yacc.c:1646  */
    {
            productions[(yyvsp[-3])] = temp_prods; 
            rem_epsilon_done[(yyvsp[-3])] = false;

            if(is_nullable == true)
            {
                nullables_left.insert((yyvsp[-3]));
                rem_epsilon_done[(yyvsp[-3])] = true;
            }
...
#line 1233 "y.tab.c" /* yacc.c:1646  */
  ...
  case 6:
#line 51 "l5.y" /* yacc.c:1646  */
    {if(temp_prod[0] != string("$")) temp_prods.pb(temp_prod); temp_prod.clear();}
#line 1239 "y.tab.c" /* yacc.c:1646  */
    break;

  case 7:
#line 52 "l5.y" /* yacc.c:1646  */
    {if(temp_prod[0] != string("$")) temp_prods.pb(temp_prod); temp_prod.clear();}
#line 1245 "y.tab.c" /* yacc.c:1646  */
    break;

  case 8:
#line 55 "l5.y" /* yacc.c:1646  */
    {is_nullable = true; temp_prod.pb(string("$"));}
#line 1251 "y.tab.c" /* yacc.c:1646  */
    break;

  case 10:
#line 59 "l5.y" /* yacc.c:1646  */
    {temp_prod.pb((yyvsp[0]));}
#line 1257 "y.tab.c" /* yacc.c:1646  */
    break;

  case 11:
#line 60 "l5.y" /* yacc.c:1646  */
    {temp_prod.pb((yyvsp[0]));}
#line 1263 "y.tab.c" /* yacc.c:1646  */
    break;

  case 12:
#line 61 "l5.y" /* yacc.c:1646  */
    {temp_prod.pb((yyvsp[0]));}
#line 1269 "y.tab.c" /* yacc.c:1646  */
    break;

  case 13:
#line 62 "l5.y" /* yacc.c:1646  */
    {temp_prod.pb((yyvsp[0]));}
